      ...
      public function index()
    {
     ...
     public function couponStatus(Request $request) {
        ...
        if($request->mode == 'true'){
            ...
            Coupons::where('id',$request->id)->update(['status'=>'inactive']);
        }
        
        return response()->json(['msg'=>'Gutscheinstatus erfolgreich aktualisiert','status'=>true]);
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,[
         ...
         if($status){
             ...
             return redirect()->route('coupon.index')->with('success','Gutschein wurde erfolgreich erstellt !');
