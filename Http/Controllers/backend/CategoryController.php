    ...
    public function store(Request $request)
    {
        ...
        if($request->is_parent==1) {
         ...
         if($status){
             ...
             return redirect()->route('category.index')->with('success','Kategorie wurde erfolgreich erstellt !');
       ...
       $data['is_parent'] = $request->input('is_parent', 0);
        if($request->is_parent==1) {
         ...
         if($status){
             ...
             return redirect()->route('category.index')->with('success','Kategorie wurde erfolgreich aktualisiert!');
    ...
    public function getChildByParentId(Request $request,$id) {
        ...
        if($category){
            ...
            if(count($child_id)<=0){
                ...
                return response()->json(['newDivOpen'=>false,'data'=>null ,'msg' =>'']);
                
            }else{
                
                 return response()->json(['newDivOpen'=>true,'data'=>$child_id ,'msg' =>'']);
