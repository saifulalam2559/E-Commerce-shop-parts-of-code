...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $image_one = time().'.'.request()->file('photo')->getClientOriginalExtension();
            ...
            if ($status) {
                ...
                return redirect()->route('banner.index')->with('success', 'Banner wurde erfolgreich erstellt !');
            } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($image) {
            ...
            $data['photo'] = 'images/banner/' . $image_one;
             ...
             return redirect()->route('banner.index')->with('success', 'Banner wurde erfolgreich aktualisiert !');
    ...
    public function destroy($id)
    {
        ...
        if($banner){
            ...
            if($status){
                ...
                return redirect()->route('banner.index')->with('success','Banner wurde gelöscht!!');
